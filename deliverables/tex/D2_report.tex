...
commands are in the accompanying execution summary (Deliverable 1).}
...
Constraints forced a \textbf{reduced-budget reproduction}: 20 of the paper's 300
...
Two observations. \code{last\_layer} peaks at its \emph{first} validation and
decays thereafter, while the supervised arms climb steadily --- consistent with
...
that needs the 300-epoch run this hardware cannot deliver.
